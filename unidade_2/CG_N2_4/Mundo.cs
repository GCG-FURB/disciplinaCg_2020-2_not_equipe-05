...
namespace gcgcg
{
    ...
    private Privado_Circulo obj_Circulo;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Novo objeto de primitivas com um array de pontos nas posições especificadas
            //Com um array de cores, [ciano, magenta, amarelo, preto]
            Primitivas p1 = new Primitivas("Primitiva1", null,
            new[] {
            new Ponto4D(200.0, 200.0, 0.0, 1.0),
            new Ponto4D(-200.0, 200.0, 0.0, 1.0),
            new Ponto4D(-200.0, -200.0, 0.0, 1.0),
            new Ponto4D(200.0, -200.0, 0.0, 1.0)}, new[] {new Cor(255, 0, 255, 255),new Cor(0, 255, 255, 255),new Cor(255, 255, 0, 255),new Cor(0, 0, 0, 0)});
            objetosLista.Add(p1);
      ...
      objetoSelecionado = obj_Circulo;
        ...
        protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
        {
            ...
            //Barra de espaço muda as primitivas
            //Não é necessário ter a referencia do objeto de primitivas pois o método
            //é estático
